...
<div class="request">
    ...
    <div class="request__tabs">
        <a href="{{ url('/admin/attendance_request') }}"
            class="request__tab {{ $activeTab === 'pending' ? 'is-active' : '' }}">
            承認待ち
        </a>

        <a href="{{ url('/admin/attendance_request/approved') }}"
        ...
        <tbody>
            @forelse ($requests as $req)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.request.show', $req->attendance_id) }}" class="request__detail-link">
                            詳細
                        </a>
                    </td>
                </tr>
